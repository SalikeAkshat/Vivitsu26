      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-20">
          ...
          <div className="flex items-center space-x-4">
            <button className="text-slate-500 font-medium hover:text-slate-900 transition-colors">Documentation</button>
            <button className="px-5 py-2.5 bg-slate-900 text-white rounded-lg font-bold text-sm hover:bg-slate-800 transition-all shadow-md">Support</button>
          </div>
        </div>
      </div>
    </nav>
